defmodule GameTest do
  ...
  test "users can take turns guessing once both have set their islands" do
    ...
    :error = Game.guess_coordinate(game, "Jim", Coordinate.new!(1,1))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(1,1))
    assert game.rules.state == :player2_turn
    {:ok, game, :hit, :dot, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(2,1))
  ...
  test "game over man, game over" do
    ...
    {:ok, game} = Game.position_island(game, "Jim", :s_shape, Coordinate.new!(1,3))
    {:ok, game} = Game.set_islands(game, "Jim")
    {:ok, game, :hit, :dot, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(2,1))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(1,1))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(1,2))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(3,1))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(2,2))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :atoll, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(3,2))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(4,1))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(4,2))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(5,1))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :square, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(5,2))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(6,1))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(7,1))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(8,1))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :l_shape, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(8,2))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(1,3))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(2,3))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :none, :no_win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(3,3))
    {:ok, game, :miss, :none, :no_win} = Game.guess_coordinate(game, "Jim", Coordinate.new!(9,9))
    {:ok, game, :hit, :s_shape, :win} = Game.guess_coordinate(game, "Allie", Coordinate.new!(3,4))
